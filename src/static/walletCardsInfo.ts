export const walletCardsInfo = [
  {
    ...
    text: "Multiple chains, one wallet. No more switching.",
  },
  {
    color: "dark" as const,
    sources: [
    ...
    text: "Seamslessly access the largest NFT marketplaces.",
  },
  {
    ...
    text: "Showcase your NFT collection.",
  },
  {
    ...
    text: "Monitor activity with transaction history and notifications.",
  },
  {
    color: "gray" as const,
    sources: [
    ...
    text: "No Limits on tokens, balances or transactions.",
  },
];
